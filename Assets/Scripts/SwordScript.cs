...
public class SwordScript : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other){
		...
		if (other.gameObject.tag == "Player" && thisRogueAI.swingActive == true){
